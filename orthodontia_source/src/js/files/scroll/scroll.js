...
export function headerScroll() {
	...
	if (header) {
		...
		let timer;
    const breakpoint = matchMedia('(min-width: 1230px)');
...
export function stickyBlock() {
	...
	function stickyBlockInit() {
		...
		if (stickyParents.length) {
			stickyParents.forEach(stickyParent => {
              ...
              document.querySelector('header.header').offsetHeight + (document.querySelector('.mobile-header') ? document.querySelector('.mobile-header').offsetHeight : 0) : 
              0
					}
	...
	function stickyBlockItem(stickyParent, stickyConfig) {
		...
		const offsetTop = document.querySelector('header.header').offsetHeight + (document.querySelector('.mobile-header') ? document.querySelector('.mobile-header').offsetHeight : 0) + stickyConfig.top;
